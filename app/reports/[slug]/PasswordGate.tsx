...
export default function PasswordGate({ slug, clientName }: PasswordGateProps) {
  ...
  // Apply theme to <html> — reads same rb_theme / time logic as the rest of the site
  useEffect(() => {
    try {
  ...
  return (
    <div className="gate-root">
      <div className="gate-card">
        ...
        {/* Subtitle */}
        <p className="gate-subtitle">Enter your access password to view your report.</p>
        ...
        {/* Footer note */}
        <p className="gate-footer">This report is private and prepared exclusively for you.</p>
      </div>
    </div>
  );
}
